---
title: Instructions
description: "Write effective system prompts that drive AI behavior."
---

# Instructions

Instructions are the system prompt that controls how the AI persona behaves during a session. This is the most impactful part of your scenario -- well-written instructions produce consistent, realistic conversations.
...
A good instruction prompt covers:
...
<Warning>
Avoid instructions that are too restrictive. If you script every response, the conversation feels robotic. Give the AI guidelines and let it adapt naturally within those bounds.
</Warning>
