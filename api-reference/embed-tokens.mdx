...
<ParamField body="end_user_id" type="string">
  Opaque identifier for the end user on your side. Stored on the meeting record so you can correlate sessions with your users. Max 128 chars.
</ParamField>
...
async def launch(request: Request):
    async with httpx.AsyncClient() as client:
        r = await client.post(
            ...
            json={
                "scenario_id": "SCENARIO_UUID",
                "end_user_id": request.state.user.id,
