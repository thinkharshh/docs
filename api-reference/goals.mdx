...
```bash
curl -X GET https://waterr.ai/backend/goals \
...
```bash
curl -X GET https://waterr.ai/backend/goals/{id} \
  -H "Authorization: Bearer YOUR_API_TOKEN"
```
...
```bash
curl -X POST https://waterr.ai/backend/goals \
  -H "Authorization: Bearer YOUR_API_TOKEN" \
...
```bash
curl -X POST https://waterr.ai/backend/goals/bulk \
  -H "Authorization: Bearer YOUR_API_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "goals": [
...
```bash
curl -X PUT https://waterr.ai/backend/goals/{id} \
  -H "Authorization: Bearer YOUR_API_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://waterr.ai/backend/goals/{id} \
  -H "Authorization: Bearer YOUR_API_TOKEN"
```
