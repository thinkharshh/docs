...
```bash
curl -X GET https://api.waterr.ai/v1/sentenced-transcripts/scenario/456 \
...
```bash
curl -X GET https://api.waterr.ai/v1/sentenced-transcripts/301/789/456 \
  -H "Authorization: Bearer wai_<your_key>"
```
...
```bash
curl -X GET https://api.waterr.ai/v1/transcripts/meeting/789 \
  -H "Authorization: Bearer wai_<your_key>"
```
